...
!(function(t, e) {
        ...
        T = (function() {
            ...
            return (
                ...
                (e._getConfig = function(t) {
                    return (t = a({}, y, t)), l.typeCheckConfig(p, t, w), t;
                }),
                (e._handleSwipe = function() {
                    ...
                    if (!(t <= 40)) {
                        ...
                        (this.touchDeltaX = 0),
                        e > 0 && (v ? this.next() : this.prev()),
                            e < 0 && (v ? this.prev() : this.next());
                    }
                }),
    ...
    i
        ...
        (i.default.fn[p] = T._jQueryInterface),
        (i.default.fn[p].Constructor = T),
        (i.default.fn[p].noConflict = function() {
            return (i.default.fn[p] = g), T._jQueryInterface;
        });
    var C = "collapse",
        S = i.default.fn[C],
        D = { toggle: !0, parent: "" },
        ...
        k = (function() {
            ...
            return (
                ...
                (e._getConfig = function(t) {
                    return (
                        ((t = a({}, D, t)).toggle = Boolean(t.toggle)),
                        l.typeCheckConfig(C, t, N),
                        t
                    );
                }),
    ...
    i
        ...
        (i.default.fn[C].noConflict = function() {
            return (i.default.fn[C] = S), k._jQueryInterface;
        });
    var A =
    ...
    function Q(t, e) {
        ...
        if ((t !== l && e !== l) || i.contains(o))
            return "BODY" === (s = (a = l).nodeName) ||
                ("HTML" !== s && B(a.firstElementChild) !== a) ?
                B(l) :
                l;
        var u = q(t);
    ...
    function it(t) {
        ...
        for (var e = t.parentElement; e && "none" === j(e, "transform");)
            e = e.parentElement;
            ...
            (void 0 === n ?
                ...
                t.enabled &&
                    ...
                    ((e.offsets.popper = J(e.offsets.popper)),
                        (e.offsets.reference = J(e.offsets.reference)),
                        (e = n(e, t)));
            }),
            e
        );
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        var n = e.x,
                            i = e.y,
                            o = t.offsets.popper,
                            r = dt(t.instance.modifiers, function(t) {
        ...
        jt = (function() {
            function t(e, n) {
                ...
                X(this, t),
                    ...
                    Object.keys(
                        $({}, t.Defaults.modifiers, o.modifiers)
                    ).forEach(function(e) {
            ...
            return (
                ...
                (e._getConfig = function(t) {
                    return (
                        ...
                        l.typeCheckConfig(Lt, t, this.constructor.DefaultType),
                        t
                    );
                }),
                ...
                (e._getPlacement = function() {
                    ...
                    return (
                        ...
                        i
                        .default(this._menu)
                        .hasClass("dropdown-menu-right") && (e = qt),
                        e
                    );
                }),
    ...
    i
        ...
        .on(
            ...
            function(t) {
                t.preventDefault(),
                    t.stopPropagation(),
                    Yt._jQueryInterface.call(i.default(this), "toggle");
            }
        )
        .on("click.bs.dropdown.data-api", ".dropdown form", function(t) {
            t.stopPropagation();
        }),
        (i.default.fn[Lt] = Yt._jQueryInterface),
        (i.default.fn[Lt].Constructor = Yt),
        (i.default.fn[Lt].noConflict = function() {
            return (i.default.fn[Lt] = Pt), Yt._jQueryInterface;
        });
    var zt = i.default.fn.modal,
        ...
        Gt = (function() {
            ...
            return (
                ...
                (e._getConfig = function(t) {
                    return (
                        (t = a({}, Xt, t)), l.typeCheckConfig("modal", t, Kt), t
                    );
                }),
    ...
    i
        ...
        (i.default.fn.modal = Gt._jQueryInterface),
        (i.default.fn.modal.Constructor = Gt),
        (i.default.fn.modal.noConflict = function() {
            return (i.default.fn.modal = zt), Gt._jQueryInterface;
        });
    var $t,
        Jt = [
            "background",
    ...
    var ie = "tooltip",
        ...
        ue =
        ((($t = { AUTO: "auto", TOP: "top" })[se ? "LEFT" : "RIGHT"] =
                "right"),
            ($t.BOTTOM = "bottom"),
            ($t[se ? "RIGHT" : "LEFT"] = "left"),
            $t),
        fe = {
            animation: !0,
        ...
        ce = (function() {
            ...
            return (
                ...
                (e.hide = function(t) {
                    ...
                    if (
                        (i.default(this.element).trigger(o), !o.isDefaultPrevented())
                    ) {
                        if (
                ...
                (e._handlePopperPlacementChange = function(t) {
                    ...
                    this._cleanTipClass(),
                        this.addAttachmentClass(
                            this._getAttachment(ue[t.placement.toUpperCase()])
                        );
                }),
    ...
    (i.default.fn[ie] = ce._jQueryInterface),
    (i.default.fn[ie].Constructor = ce),
    (i.default.fn[ie].noConflict = function() {
        return (i.default.fn[ie] = oe), ce._jQueryInterface;
    });
    var he = "popover",
        pe = i.default.fn[he],
    ...
    (i.default.fn[he] = be._jQueryInterface),
    (i.default.fn[he].Constructor = be),
    (i.default.fn[he].noConflict = function() {
        return (i.default.fn[he] = pe), be._jQueryInterface;
    });
    var ye = "scrollspy",
        we = i.default.fn[ye],
    ...
    i.default(window).on("load.bs.scrollspy.data-api", function() {
        ...
        (i.default.fn[ye] = Ce._jQueryInterface),
        (i.default.fn[ye].Constructor = Ce),
        (i.default.fn[ye].noConflict = function() {
            return (i.default.fn[ye] = we), Ce._jQueryInterface;
        });
    ...
    i
        ...
        .on(
            ...
            function(t) {
                t.preventDefault(),
                    De._jQueryInterface.call(i.default(this), "show");
            }
        ),
        (i.default.fn.tab = De._jQueryInterface),
        (i.default.fn.tab.Constructor = De),
        (i.default.fn.tab.noConflict = function() {
            return (i.default.fn.tab = Se), De._jQueryInterface;
        });
    ...
    (i.default.fn.toast = Ie._jQueryInterface),
    (i.default.fn.toast.Constructor = Ie),
    (i.default.fn.toast.noConflict = function() {
        return (i.default.fn.toast = Ne), Ie._jQueryInterface;
    }),
    (t.Alert = d),
    (t.Button = h),
    (t.Carousel = T),
