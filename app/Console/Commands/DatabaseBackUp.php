...
class DatabaseBackUp extends Command
{
    ...
    public function handle()
    {
        if (\Config::get('database.default') != strtolower('mysql')) {
            ...
            $filename = "backup-Codies" . Carbon::now()->format('Y-m-d-H-i-s') . ".sql";
            $command = "mysqldump -uroot -pDb2@dm1n2022 --databases --add-drop-database codies  > " . base_path() . "/app/backup/daily/" . $filename;
            $returnVar = NULL;
            $output  = NULL;
